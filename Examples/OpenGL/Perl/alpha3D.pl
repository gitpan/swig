...
sub myinit {
    my $mat_ambient = newfv4(0.0,0.0,0.0,0.15);
    my $mat_specular = newfv4(1.0, 1.0, 1.0, 0.15 );
    my $mat_shininess = newfv4(15.0,0,0,0);
...
sub display {
    my $position = newfv4( 0.0, 0.0, 1.0, 1.0 );
    my $mat_torus = newfv4( 0.75, 0.75, 0.0, 1.0 );
    my $mat_cylinder = newfv4( 0.0, 0.75, 0.75, 0.15 );
