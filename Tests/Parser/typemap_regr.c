 ...
 */
	 ...
	 SWIG_RegisterMapping("_struct_varstruct","_varstruct",0);
	 SWIG_RegisterMapping("_INT32","_Integer",0);
	 SWIG_RegisterMapping("_INT32","_unsigned_int",0);
	 SWIG_RegisterMapping("_INT32","_signed_int",0);
	 SWIG_RegisterMapping("_INT32","_int",0);
	 ...
	 SWIG_RegisterMapping("_signed_int","_INT32",0);
	 SWIG_RegisterMapping("_signed_int","_Integer",0);
	 SWIG_RegisterMapping("_signed_int","_int",0);
	 SWIG_RegisterMapping("_struct_atest3","_atest3",0);
	 SWIG_RegisterMapping("_struct_atest7","_atest7",0);
	 SWIG_RegisterMapping("_unsigned_short","_short",0);
	 SWIG_RegisterMapping("_varstruct","_struct_varstruct",0);
	 SWIG_RegisterMapping("_signed_short","_short",0);
	 SWIG_RegisterMapping("_unsigned_int","_INT32",0);
	 SWIG_RegisterMapping("_unsigned_int","_Integer",0);
	 SWIG_RegisterMapping("_unsigned_int","_int",0);
	 SWIG_RegisterMapping("_short","_unsigned_short",0);
	 SWIG_RegisterMapping("_short","_signed_short",0);
	 SWIG_RegisterMapping("_int","_INT32",0);
	 SWIG_RegisterMapping("_int","_Integer",0);
	 SWIG_RegisterMapping("_int","_unsigned_int",0);
	 SWIG_RegisterMapping("_int","_signed_int",0);
	 SWIG_RegisterMapping("_Integer","_INT32",0);
	 SWIG_RegisterMapping("_Integer","_int",0);
	 SWIG_RegisterMapping("_Integer","_signed_int",0);
	 SWIG_RegisterMapping("_Integer","_unsigned_int",0);
	 SWIG_RegisterMapping("_atest3","_struct_atest3",0);
	 SWIG_RegisterMapping("_atest7","_struct_atest7",0);
